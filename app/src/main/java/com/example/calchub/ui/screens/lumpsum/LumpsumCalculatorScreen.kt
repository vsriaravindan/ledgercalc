package com.example.calchub.ui.screens.lumpsum
...
/**
 * Screen for calculating Lumpsum investment returns.
 * Shows investment growth over time based on a fixed return rate.
 *
